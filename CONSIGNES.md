# CONSIGNES (énoncé original du travail synthèse)
...
- **Bonus 1 :** Une tête de lecture est aussi visible pour indiquer la position en temps dans la chanson.
- **Bonus 2 :** La tête de lecture est également fonctionnelle et permet de parcourir la chanson.
- **Bonus 3 :** L'application se démarque par son originalité, ses fonctionnalités ou son excellence stylistique.
